        ...
        <>
            <nav className="block w-full max-w-screen-lg px-4 py-2 mx-auto bg-white shadow-md rounded-md lg:px-8 lg:py-3 mt-10">
                <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                    ...
                    <Link className="mr-4 block cursor-pointer py-1.5 text-base text-slate-800 font-semibold" to="/">
                        Cash GPT
                    </Link>
                    ...
                    <div className="hidden lg:block">
                        <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                            <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
                                ...
                                <Link className="flex items-center" to="/users">Users</Link>
                            </li>
                            <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-6 w-6 text-slate-500">
                                ...
                                <Link className="flex items-center" to="/expenses">Expenses</Link>
                            </li>
                            <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-6 w-6 text-slate-500">
                                 ...
                                 <Link className="flex items-center" to="/accounts">Accounts</Link>
                            </li>
                            {/* <li
